...
class TestQwen3Registration:
    def test_registered(self) -> None:
        from after_meeting.stt import _PROVIDERS, _ensure_builtins
        _ensure_builtins()
...
class TestQwen3Provider:
    def test_implements_protocol(self) -> None:
        from after_meeting.stt.base import STTProvider
        from after_meeting.stt.qwen3 import Qwen3Provider
